  ...
  return (
    <div className="prose prose-slate max-w-none">
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        These Terms of Service (&quot;Terms&quot;) govern your access to and use of Taxio, an automated invoice
      ...
      <p className="text-slate-700 mb-3">Taxio offers:</p>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>
          You must be at least <strong className="text-slate-800">18 years old</strong> to use Taxio.
        </li>
        <li>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>
          Taxio uses <strong className="text-slate-800">OpenAI (ChatGPT)</strong> and other third-party APIs to
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        ...
        <li>
          Taxio does <strong className="text-slate-800">not claim any rights</strong> over your data.
        </li>
        <li>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>
          Taxio is provided <strong className="text-slate-800">&quot;as is&quot;</strong>, without warranties of any
          kind.
        </li>
        <li>
        ...
        <li className="bg-yellow-50 p-3 border-l-4 border-yellow-400">
          <strong className="text-slate-800">âš ï¸ Important:</strong> Taxio is{" "}
