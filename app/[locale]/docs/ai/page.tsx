  ...
  return (
    <div className="prose prose-slate max-w-none">
      ...
      <p className="bg-slate-50 p-4 rounded-lg border border-slate-200 mb-6">
        ...
        <a href="https://Taxio.app" className="text-blue-600 hover:text-blue-800">
          https://Taxio.app
        </a>
      </p>

      <p className="text-gray-700 leading-relaxed mb-6">
        At Taxio, we use artificial intelligence (&quot;AI&quot;) to power the core features of our platform. This
        document outlines how and why we use AI technologies, what data is processed, and how it may affect you as a
        user.
      </p>

      <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">1. Purpose of AI in Taxio</h2>
      <p className="text-gray-700 leading-relaxed mb-3">AI is essential to the Taxio experience. It is used for:</p>
      ...
      <p className="bg-amber-50 p-4 rounded-lg border border-amber-200 mb-4">
        <strong className="text-amber-600">âš ï¸ Note:</strong> This data is <strong>not anonymized or redacted</strong>{" "}
        before transmission. By using Taxio, you acknowledge and consent to this transfer.
      </p>
      <p className="text-gray-700 leading-relaxed mb-6">
      ...
      <p className="text-gray-700 leading-relaxed mb-6">
        AI processing is a fundamental component of Taxio and cannot be disabled. If you do not consent to your data
      ...
      <p className="bg-red-50 p-4 rounded-lg border border-red-200 mb-6">
        <strong className="text-red-600">âš ï¸ Important:</strong> Taxio is <strong>not a substitute</strong> for a
