  ...
  return (
    <div className="prose prose-slate max-w-none">
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        Taxio (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) is committed to protecting your privacy. This
      ...
      <p className="text-slate-700 mb-3">We collect the following types of data when you use Taxio:</p>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>Create and manage your Taxio account</li>
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        By using Taxio, you consent to the transfer of relevant data to these third-party providers for the purpose
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        Taxio does <strong className="text-slate-800">not use tracking cookies</strong> or third-party analytics. We
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        Taxio is <strong className="text-slate-800">not intended for users under the age of 18</strong>. We do not
